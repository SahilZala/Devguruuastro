...
import com.krash.devguruuastro.databinding.ActivityWalletBinding;
...
public class WalletActivity extends AppCompatActivity implements PaymentResultListener {
        ...
        binding.rechargeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((binding.radioGroup.getCheckedRadioButtonId() == -1) && (binding.amountET.getText().toString().equals(""))) {
                    ...
                    if (Integer.parseInt(binding.amountET.getText().toString()) < 50) {
                        Toast.makeText(WalletActivity.this, "Amount should be minimum ₹50", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    public void startRecharge() {
        ...
        checkout.setKeyID("rzp_test_FVGrpFtYVKkW9x");
