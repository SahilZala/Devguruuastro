        ...
        if (getIntent().getStringExtra("comesfrom").equalsIgnoreCase("user")) {
            ...
            astrodata.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    FcmNotificationsSender fns = new FcmNotificationsSender(snapshot.getValue().toString(), "chat", "you have chat invitation", getApplicationContext(), ChatActivity.this);
