...
public class UserChatActivity extends AppCompatActivity {
    ...
    com.krash.devguruuastro.databinding.ActivityChatBinding binding;
    com.krash.devguruuastro.databinding.UserInfoLayoutBinding userInfoLayoutBinding;
...
//                                                });
    ...
    void endChat() {
        ...
        astMap.put("earning", "" + (((duration - (int) (remainedSecs / 60)) * astPrice) / 2));
        astMap.put("orderType", "Chat");

        double total = (((duration - (int) (remainedSecs / 60)) * astPrice) / 2);
    ...
    void fetchDataAstroData() {
        ...
        astrodata.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                FcmNotificationsSender fns = new FcmNotificationsSender(snapshot.getValue().toString(), "chat", "you have chat invitation", getApplicationContext(), UserChatActivity.this);
