...
import com.krash.devguruuastros.databinding.ForgotPassDialogBinding;
                                    ...
                                    databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            if (snapshot.child("isVerified").getValue().equals("false")) {
                                                ...
                                                Toast.makeText(LoginActivity.this, "Astrologer not verified yet !", Toast.LENGTH_SHORT).show();
                                            } else {
