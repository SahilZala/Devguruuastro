...
public class AstOrder {
    ...
    public AstOrder(String userUID, String orderID, String orderDate, String duration, String earning, String name, String apayment, String geteway, String orderTime, String orderType, String tds, String userpaid) {
        UserUID = userUID;
        this.orderID = orderID;
        this.orderDate = orderDate;
        this.duration = duration;
